...
| [external-evidence-request.md](external-evidence-request.md) | Public-safe checklist for AWS sandbox and reader-test evidence needed to unblock remaining plan work. | External validation prerequisites, evidence fields, or privacy rules change. |
...
| [reader-test-results-template.md](reader-test-results-template.md) | Template for recording KB-14 reader-task sessions without unnecessary personal data. | Reader-task fields, privacy rules, or maintenance feedback workflow changes. |
...
| [git/github-actions/content-ci-cd-process.md](git/github-actions/content-ci-cd-process.md) | Content-only CI/CD process. | Repository merge target, review expectation, validation, branch cleanup, or `main` workflow guidance changes. |
...
| [kubernetes/crossplane/xrd-composition-and-xr-calls.md](kubernetes/crossplane/xrd-composition-and-xr-calls.md) | Beginner Crossplane XRD, Composition, XR, and Terraform module-call analogy guide. | XRD versus Composition explanations, XR call terminology, composition selection, naming rules, or Terraform analogy guidance changes. |
...
| [kubernetes/crossplane/terraform-vs-crossplane.md](kubernetes/crossplane/terraform-vs-crossplane.md) | Terraform versus Crossplane comparison and decision guide. | Terraform comparison, plan/apply versus reconciliation, module versus XRD, self-service, platform API, or ownership-boundary guidance changes. |
...
| [kubernetes/applications-and-tools/k9s.md](kubernetes/applications-and-tools/k9s.md) | K9s terminal UI guidance. | K9s navigation, inspection workflows, filters, aliases, hotkeys, plugins, RBAC, or read-only usage changes. |
...
| [migrations/velero/possible-integrations.md](migrations/velero/possible-integrations.md) | GitHub Actions and automation runner patterns for Velero backup, restore, and migration tasks. | Velero pipeline, GitHub Actions, automation, OIDC, EKS runner access, or operation-file guidance changes. |
...
| [ai/ai-tooling/README.md](ai/ai-tooling/README.md) | AI tooling section index. | MCP, AI tools, skills, retrieval, or knowledge-base tooling routes change. |
| [ai/ai-tooling/model-context-protocol.md](ai/ai-tooling/model-context-protocol.md) | Model Context Protocol guide. | MCP host, client, server, tool, resource, prompt, transport, schema, or safety guidance changes. |
| [ai/ai-tooling/create-ai-tools-for-claude-and-codex.md](ai/ai-tooling/create-ai-tools-for-claude-and-codex.md) | Claude and Codex custom AI tools guide. | Claude tools, Claude Code skills, Codex skills, Codex plugin, function-tool, or MCP integration guidance changes. |
| [ai/ai-tooling/knowledge-bases-creation-management-and-optimization.md](ai/ai-tooling/knowledge-bases-creation-management-and-optimization.md) | Compatibility entry point for agent knowledge-base creation, management, retrieval, optimization, and OKF guidance. | Markdown knowledge-base, retrieval, lifecycle, provenance, or OKF guidance changes. |
| [ai/ai-tooling/knowledge-bases/README.md](ai/ai-tooling/knowledge-bases/README.md) | Agent-first, Git-backed, standards-aware knowledge-base reference architecture index. | OKF, knowledge standards, reference architecture, retrieval budgets, provenance, freshness, security, governance, evaluation, or example bundles change. |
| [ai/ai-tooling/knowledge-bases/okf-v0.2.md](ai/ai-tooling/knowledge-bases/okf-v0.2.md) | OKF v0.2 specification audit and implementation guide. | OKF conformance, lifecycle, actors, sources, trust, freshness, or Attested Computation guidance changes. |
| [ai/ai-tooling/knowledge-bases/examples/okf-v0.2/index.md](ai/ai-tooling/knowledge-bases/examples/okf-v0.2/index.md) | Dedicated public-safe OKF v0.2 example bundle. | Example OKF bundle concepts, root version declaration, reserved files, or conformance examples change. |
