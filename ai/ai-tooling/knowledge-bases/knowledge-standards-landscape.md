...
| --- | --- | --- | --- | --- |
| Knowledge packaging | OKF v0.2 | Open specification | GoogleCloudPlatform `knowledge-catalog` | Portable Markdown and YAML-frontmatter bundle for humans and agents. |
