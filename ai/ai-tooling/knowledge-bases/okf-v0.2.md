...
OKF is an open specification maintained in the GoogleCloudPlatform `knowledge-catalog` repository. It is not an ISO, IETF, or W3C standard. Treat it as a practical interchange format for curated knowledge, not as a semantic-web replacement, retrieval engine, database, API runtime, or authorization system.

## What OKF is

| Property | OKF v0.2 model |
| --- | --- |
| Steward | GoogleCloudPlatform `knowledge-catalog` project. |
