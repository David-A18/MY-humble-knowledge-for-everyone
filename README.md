...
| Crossplane platform APIs | [Crossplane](crossplane/README.md) | [XRDs and Compositions](crossplane/xrd-and-compositions/README.md), [examples](crossplane/examples/README.md), [Terraform comparison](crossplane/comparison/terraform-vs-crossplane.md), [Crossplane on AWS](cross-topic-guides/crossplane-on-aws.md). |
