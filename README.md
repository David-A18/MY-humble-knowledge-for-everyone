...
| Crossplane platform APIs | [Crossplane](crossplane/README.md) | [XRDs and XRs](crossplane/xrd-and-xr/README.md), [Compositions](crossplane/compositions/README.md), [AWS VPC platform API](crossplane/examples/aws-vpc-platform-api.md), [Terraform comparison](crossplane/comparison/terraform-vs-crossplane.md), [Crossplane on AWS](cross-topic-guides/crossplane-on-aws.md). |
