...
| --- | --- | --- |
| [Cloud](cloud/README.md) | [Cloud solutions](cloud/solutions/README.md), [AWS](cloud/aws/README.md), [Azure](cloud/azure/README.md), [Google Cloud](cloud/gcloud/README.md), [edge and CDN](cloud/edge/README.md) | Provider-neutral cloud guidance plus provider-specific architecture, networking, security, operations, and cost notes. |
...
| [AI](ai/README.md) | [AI tooling](ai/ai-tooling/README.md), [agent knowledge bases](ai/ai-tooling/knowledge-bases/README.md), AI systems, MCP, custom tools, knowledge-base patterns, safety, engineering use | AI concepts, workflows, tool integrations, Markdown knowledge bases, systems, safety, and engineering use. |
