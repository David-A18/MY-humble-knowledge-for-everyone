...
A practical, long-term engineering knowledge base for Git, GitHub Actions, Terraform, Kubernetes, AWS, FinOps, cloud architecture, troubleshooting, and engineering best practices.
...
| [AWS](aws/README.md) | Cloud fundamentals, networking, compute, storage, security, FinOps, architecture, and certification notes. |
