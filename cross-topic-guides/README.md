...
| First local learning route | [Local deployment learning path](local-deployment-learning-path.md) | [Start here](../start-here.md), [Kubernetes fundamentals](../kubernetes/fundamentals/README.md), [Git undo and recovery](../git/troubleshooting/undo-and-recovery.md). |
