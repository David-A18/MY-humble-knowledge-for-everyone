...
| [Terraform state management](knowledge/terraform/fundamentals/state-management.md) | Unassigned | 2026-12-19 | State guidance is operationally sensitive | Terraform source review and local exercise execution | Backend-specific locking, drift, and recovery drills |
